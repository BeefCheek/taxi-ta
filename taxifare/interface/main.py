...
def preprocess(min_date:str = '2009-01-01', max_date:str = '2015-01-01') -> None:
    ...
    data_processed_time = pd.DataFrame(np.concatenate((
        data_clean[["pickup_datetime"]],
        X_processed,
        y,
    ), axis=1))
    print(data_processed_time.shape)

    load_data_to_bq(data_processed_time, GCP_PROJECT, BQ_DATASET, table=f'processed_{DATA_SIZE}',
        truncate=True)
